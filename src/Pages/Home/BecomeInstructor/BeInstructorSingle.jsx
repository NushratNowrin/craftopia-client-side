...
const BeInstructorSingle = (instructor) => {
    ...
    return (
        <div className='relative text-center pt-16 become-instructor'>
            ...
            <p className='absolute top-8 instructor-id text-2xl bg-[#8EA6EB] w-20 h-16 text-white font-bold rounded-full flex justify-center items-center z-20'>{id}</p>
            <p className='absolute top-8 text-2xl bg-white w-20 h-16 text-white font-bold rounded-full flex justify-center items-center z-10'>{id}</p>
