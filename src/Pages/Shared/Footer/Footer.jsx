...
const Footer = () => {
    return (
        ...
        <div className='text-white footer p-20 bg-black md:flex justify-between'>
            ...
            <div>
                <div className='footer-title font-semibold text-lg text-red-500 my-5'>Contact info</div>
            ...
            <div>
            <div className='footer-title font-semibold text-lg text-red-500 my-5 '>Address</div>
            <p> Navana Yusuf Infinity,<br /> Bir Uttam AK Khandakar Rd,<br /> Dhaka 1212</p>
            </div>
        </div>

        {/* Copyright */}
        <div className='text-white footer items-center py-4 md:px-20 px-10  bg-gray-900 text-neutral-content md:flex justify-between'>
